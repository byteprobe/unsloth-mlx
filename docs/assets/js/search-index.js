...
window.MLX_SEARCH_INDEX = [
  ...
  { title: "MoE Fine-Tuning", section: "Mixture of Experts", url: "llm.html#moe", tags: "moe mixture experts switch linear qwen phi mixtral gemma4 afmoe trinity arcee shared routed sigmoid gated attention", page: "LLM" },
  { title: "Trinity-Nano (AFMoE)", section: "Arcee Foundation MoE", url: "llm.html#moe", tags: "arcee trinity afmoe 6b 1b active 128 experts shared expert sigmoid routing gated attention", page: "LLM" },
  ...
  { title: "Trinity-Nano SFT", section: "Example 54", url: "examples.html#moe", tags: "trinity afmoe arcee example 54 sft instruction moe per-expert lora finetome", page: "Examples" },
  { title: "Trinity-Nano GRPO", section: "Example 55", url: "examples.html#moe", tags: "trinity afmoe arcee example 55 grpo reasoning gsm8k reward math", page: "Examples" },
  { title: "Trinity-Nano CPT", section: "Example 56", url: "examples.html#moe", tags: "trinity afmoe arcee example 56 cpt continual pretraining wikitext domain adaptation", page: "Examples" },
